  ...
  return (
    <>
      ...
      <div className="game-root">
        ...
        {screen === "student" && <StudentDashScreen onNavigate={setScreen} />}
        {screen === "game" && <GameScreen onNavigate={setScreen} />}
        {screen === "parent" && <ParentDashboard onNavigate={setScreen} />}
        {screen === "teacher" && <TeacherDashboard onNavigate={setScreen} />}
      </div>
    </>
  );
}
